...
export default class AccountInfo {
    ...
    constructor(props) {
         ...
         */
        this.U2UAllowances = props.U2UAllowances;
        /*
         * @deprecated - no longer supported
         */
        ...
        return {
            ...
            proxyAccountID:
                ...
                this.proxyAccountId != null
                    ...
                    : null,
            proxyReceived: this.proxyReceived.toTinyU2U(),
            key: this.key._toProtobufKey(),
            balance: this.balance.toTinyU2U(),
            generateSendRecordThreshold: this.sendRecordThreshold.toTinyU2U(),
            generateReceiveRecordThreshold:
                this.receiveRecordThreshold.toTinyU2U(),
